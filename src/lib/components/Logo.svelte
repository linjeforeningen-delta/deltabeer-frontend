<script lang="ts">
    ...
    let w = `${width}px`;
    let h = `${height}px`;
    let viewBox = `0 0 130 86`;
</script>

<svg width={w} height={h} {viewBox} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <!-- Generator: Sketch 41.2 (35397) - http://www.bohemiancoding.com/sketch -->
    <title>Path</title>
    <desc>Created with Sketch.</desc>
    <defs></defs>
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="chrome-touch-icon-192x192" transform="translate(-31.000000, -23.000000)" fill={color}>
